...
python train.py --config dvc1_tv_sml-60_gop-a_Ife-clip_ur-0_ut-1_pfe-resp_a-40.json
python train.py --config dvc1_tv_sml-60_gop-a_Ife-clip_ur-0_ut-1_pfe-resp_a-60.json
